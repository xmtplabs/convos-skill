...
If you haven't been supplied an invite URL, slug, or conversation ID, ask the user for a conversation invite link from the Convos app. Then proceed with setup, joining, and running the bridge script as described below.
